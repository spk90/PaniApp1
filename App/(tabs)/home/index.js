...
const index = () => { 
  ...
  const fetchProducts =()=>{
    services.map((service)=> disptach(getProducts(service))
    );
  }
  fetchProducts();
  ...
  const services = [
    {
      id: "0",
      image: "https://5.imimg.com/data5/EB/UZ/GF/SELLER-9030254/ro-raw-material-20-leter-jar-500x500.jpg",
      name: "Jar",
      quantity: 0,
      price: 50,
    },
    {
      id: "11",
      image: "https://miro.medium.com/v2/resize:fit:600/1*-bEwpwk-u9eQeEIGOjfB4w.jpeg",
      name: "Water Tanker",
      quantity: 0,
      price: 1500,
    }
